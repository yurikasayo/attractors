export class Shader {
    constructor(renderer, vertexShader, fragmentShader, varyings) {
        this.gl = renderer.gl;

        this.createShader(vertexShader, fragmentShader, varyings);
        
        this.attributes = [];
        this.uniforms = [];
    }

    createShader(vertexShader, fragmentShader, varyings) {
        const gl = this.gl;
        ...
        if (varyings) gl.transformFeedbackVaryings(this.program, varyings, gl.SEPARATE_ATTRIBS);
